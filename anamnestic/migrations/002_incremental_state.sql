...
-- - anamnestic_ingest_state: track last processed file mtime per source
...
CREATE TABLE IF NOT EXISTS anamnestic_ingest_state (
...
CREATE TABLE IF NOT EXISTS anamnestic_embed_state (
